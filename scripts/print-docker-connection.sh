...
echo "# Desktop control-api base (JWT login + REST): prefer nginx URL when TLS/proxy is used, else direct port."
echo "export CONTROL_API_PUBLIC=http://${HOST}:${DASHBOARD_PORT}"
echo ""
